...
const (
	...
	Auth_Verify_FullMethodName   = "/proto.auth/Verify"
...
func (c *authClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
...
func (c *authClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuccessResponse)
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterRequest) (*SuccessResponse, error) {
...
func (UnimplementedAuthServer) Logout(context.Context, *LogoutRequest) (*SuccessResponse, error) {
